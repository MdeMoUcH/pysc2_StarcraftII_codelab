...
#GLOBAL_MINIGAME = "HallucinIce"
GLOBAL_MINIGAME = "DefeatRoaches"
GLOBAL_STEPS = 900
GLOBAL_STEPS_WARMUP = 300
GLOBAL_STEPS_EPISODE = 300
...
FLAGS = flags.FLAGS
flags.DEFINE_string("mini_game", GLOBAL_MINIGAME, "Name of the minigame.")
...
class Environment(sc2_env.SC2Env):
    ...
    def __init__(self):
        ...
        super().__init__(map_name=FLAGS.mini_game, 
                        ...
                        game_steps_per_episode=GLOBAL_STEPS_EPISODE,
...
def training_game():
    ...
    policy = LinearAnnealedPolicy(EpsGreedyQPolicy(), attr="eps", value_max=1, value_min=0.7, value_test=.0, nb_steps=GLOBAL_STEPS)
    ...
    dqn.fit(env, nb_steps=GLOBAL_STEPS, action_repetition=2, log_interval=1000, verbose=2)
